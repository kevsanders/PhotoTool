 ...
 * <p>
 * from: https://raw.githubusercontent.com/rkalla/exiftool/master/src/main/java/com/thebuzzmedia/exiftool/ExifTool.java
 */
...
public class ExifTool {
    ...
    protected static void checkFeatureSupport(Feature... features)
        ...
        for (int i = 0; i < features.length; i++) {
            ...
            if (ver != null && Double.valueOf(ver).compareTo(Double.valueOf(feature.version)) >= 0) {
...
*/
    ...
    public enum Tag {
        ISO("ISO", Integer.class), APERTURE("ApertureValue", Double.class), WHITE_BALANCE(
                ...
                "Rating", Integer.class), RATING_PERCENT("RatingPercent",Integer.class),
                DATE_TIME_ORIGINAL("DateTimeOriginal", String.class),
                CREATE_DATE("CreateDate", String.class),
                MODIFY_DATE("ModifyDate", String.class),
                GPS_LATITUDE( "GPSLatitude", Double.class), GPS_LATITUDE_REF(
...
/*
            streams.writer.write("-csv\n");
            streams.writer.write("-d\n");
            streams.writer.write("%Y-%m-%d\n");
*/
